function main () {
    ...
    // ovo su sad arrays gde je prva slika coursesImage[0], druga slika coursesImage[1] i treca coursesImage[2]
...
previous.addEventListener('click', function(){
    ...
    if(isMobile){
        ...
        // ovo treba da se izvrsi za sva tri pracena indeksa is "courses"
        for (let i = 0; i < counters.length; i++) {
            ...
            //prosledimo index ovoj funkciji da zna u koji od tri kontejnera smesta koji objekat 
            desktopChanger(i);
        }
        
        // ovo sve moze u jednu funkciju
...
// ovako deklarisemo funkcije!
let desktopChanger = function (i) {
    // od 3 slike jednoj po jednoj dodeljuje vrednost iz coursesSlider
    // ako je i = 0 onda je counters[i] vrednost prvog brojaca (od 3), a ta vrednost ce da odredi koji od objekata iz coursesSlider pozivamo
    ...
    coursesAvatar[i].src = coursesSlider[counters[i]].avatarImage;
    nameAvatar[i].textContent = coursesSlider[counters[i]].name;
}
