...
if(isMobile){
    ...
    coursesImage[0].src = coursesSlider[0 + counter].image;
    if (counter === coursesSlider.length - 2){
        coursesImage[1].src = coursesSlider[1 + counter].image;
        ...
        coursesImage[1].src = coursesSlider[1 + counter].image;
        coursesImage[2].src = coursesSlider[2 + counter].image;
    }
}
...
//         if (index[i] < 0){
//             index[i] = coursesSlider.length;
//         }else if (index[i] >= coursesSlider.length){
//             index[i] = 0
//         }
//         changeSlider(i);
//     }
