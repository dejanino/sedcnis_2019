function main (){
    ...
    function courseLogic (studentReviews) {
        ...
        let changeStudentReview = function (index){
            ...
            //maximalni broj zvezdica koji moze da ima svaki student je 5
            for(var i=0; i < 5; i++){
                // ispitujem da li vec postoji klasa sa zvezdicama
                if (studentStarsDiv.classList.contains('fas fa-star')){
                    studentStarsDiv.removeChild(star);
                }
                else if (i < studentStars){
